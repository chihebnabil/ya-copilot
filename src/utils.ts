...
/**
 * Function to get ignore patterns from settings
 */
...
export async function readFilesTreeAsASCII(
    ...
    const settingsIgnorePatterns = getIgnorePatternsFromSettings();
    ignorePatterns = [...new Set([...ignorePatterns, ...settingsIgnorePatterns])];
